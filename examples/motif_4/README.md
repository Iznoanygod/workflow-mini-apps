# Digital Replica Motif Workflow Mini-app
Workflow mini-app build based on an Digital Replica workflow. 
...
- `$ cd workflow-mini-apps/examples/motif_4`
- `$ dragon -s workflow_async.py`
